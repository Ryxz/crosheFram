...
public class ImageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mImageView = (ImageView) v.findViewById(R.id.android_base_image);
        tv_progress = (TextView) v.findViewById(R.id.android_base_tv_progress);
        ...
        progressBar = (ProgressBar) v.findViewById(R.id.android_base_loading);
        return v;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ImageLoader.getInstance().displayImage(mImageUrl, mImageView, CroSheAppContext.getInstance().image_display_options, new SimpleImageLoadingListener() {
            @Override
