...
public class MarketFragment04 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_market_04,container,false);
        return view;
    }
    ...
    public void initView(){
        recyclerView= (RecyclerView) getActivity().findViewById(R.id.tv_re_lei_4);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        adapter = new SeedsAdapter(seedlist,getActivity());
        recyclerView.setAdapter(adapter);

        tv1= (TextView) getActivity().findViewById(R.id.tv_fertilizer_1);
        tv2= (TextView) getActivity().findViewById(R.id.tv_fertilizer_2);
        tv3= (TextView) getActivity().findViewById(R.id.tv_fertilizer_3);
        tv4= (TextView) getActivity().findViewById(R.id.tv_fertilizer_4);
        ll_all= (LinearLayout) getActivity().findViewById(R.id.tv_all_4);
    }
