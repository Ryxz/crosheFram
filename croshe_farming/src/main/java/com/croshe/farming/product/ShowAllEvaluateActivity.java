...
public class ShowAllEvaluateActivity extends CrosheBaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_show_alleva);
    ...
    public void initView() {
        ...
        refresh_show_alleva = (BGARefreshLayout) findViewById(R.id.refresh_show_alleva);
        refresh_show_alleva.setDelegate(this);
        refresh_show_alleva.setRefreshViewHolder(new BGANormalRefreshViewHolder(this,true));
        recycler_show_alleva = (RecyclerView) findViewById(R.id.recycler_show_alleva);
    ...
    public void showAllComment(final int page){
        this.page = page;
        HttpRequest.showAllComment(context, productId, page, new ServerResultListener() {
            @Override
